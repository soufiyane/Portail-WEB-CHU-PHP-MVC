			...
			<div id="liste" align="center">	
				<form method="post" action="admin_newincident_insert.php">
					<table align="center" width="50%">
						...
						<tr>
							<td>
								<h2 class="info">Problème:</h2>
							</td>
							<td align="center">
								<textarea class="form-control" rows="9" cols="42" name="probleme" onfocus="if (this.value=='Décrire le problème tel qu\'il sera proposé aux étudiants.') this.value=''"><?php if(isset($_GET['id_autre'])){ if ($_GET['id_autre'] != '') { echo $pb; }} else { ?>Décrire le problème tel qu'il sera proposé aux étudiants.<?php } ?></textarea>
							</td>
						</tr>
						<tr> 
							<td>
						...
						<tr id="solution2" style=display:none>
							<td> </td>
							<td align="center">
								<textarea class="form-control" rows="9" cols="42" name="solution2" onfocus="if (this.value=='Deuxième solution') this.value=''">Deuxième solution</textarea>
								<br />
						...
						<tr id="solution3" style=display:none>
							<td> </td>
							<td align="center">
								<textarea class="form-control" rows="9" cols="42" name="solution3" onfocus="if (this.value=='Troisième solution') this.value=''">Troisième solution</textarea>								
							</td>
						</tr>
					</table>
					<br /><br />
