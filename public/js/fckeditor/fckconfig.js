...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Cut','Copy','Paste','PasteText','PasteWord','-','SpellCheck','Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
...
FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','Templates']
] ;
