    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav cc">
                <li><a href="<?php echo $_SESSION['racine']?>incidents/rediger_incident"
                <?php
                ...
                <li><a href="<?php echo $_SESSION['racine']?>incidents/mes_problemes"
                <?php
                ...
                <li><a href="<?php echo $_SESSION['racine']?>incidents/problemes_resolus"
                <?php
                ...
                <li><a href="<?php echo $_SESSION['racine']?>incidents/mes_infos"
                <?php
                $masque = "#mes_infos#i";
                if (preg_match($masque, $monUrl1)) {
                    echo 'class = "current" id="current"';
                ...
                <li><a href="<?php echo $_SESSION['racine']?>incidents/mes_outils"
                <?php
                $masque = "#mes_outils#i";
                if (preg_match($masque, $monUrl1)) {
                    echo 'class = "current" id="current"';
