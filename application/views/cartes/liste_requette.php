...
<form  role="form" method="post" name="formulairetotal" id="formulairetotal" ACTION="liste_requette" METHOD="POST" ENCTYPE="multipart/form-data" style="margin-left:0px;width:100%;" >
