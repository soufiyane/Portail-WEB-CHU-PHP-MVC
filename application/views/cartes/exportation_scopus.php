<div class="fw-body">
    <div class="content">
    <div align="left">
        <h1 class="page_title">Exportation vers scopus : (il faut faire l'exportation école par école)</h1>
<?php  include ('../public/js/includes/variables_annee.php');?>
<form  role="form" method="post" name="formulairetotal" id="formulairetotal" ACTION="exportation_scopus" METHOD="POST" ENCTYPE="multipart/form-data" style="margin-left:0px;width:100%;" >
