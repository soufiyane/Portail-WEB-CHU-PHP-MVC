 ...
 <form role="form" id="myForm" action='retour_casque_etudiant' method='POST'>
                        <div class="row" style='padding-top: 40px;'>
			            <div class="form-group col-sm-6" id="user">
			            <p style=" float:left">Rechercher un utilisateur :</p>
                                <input  type='text' class="form-control" autocomplete='off' size='40' value='' name='etudiant' id='inputStringc' />
